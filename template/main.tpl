		...
		<div class="modal-content">
			...
			<div class="modal-body" style="font-size:24px">				  
				<ol>
					...
					<li>Не рекламировать другие сайты</li>
		...
		<div id="tab1" class="tab-group" style="height: 515px;">
			<div class="dropdown" style="margin: -10px; font-family: 'Ubuntu-Medium'; font-size: 13px; padding: 20px; padding-bottom: 10px; text-align: center;">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="true">
					<span class="lang-select">РУССКАЯ КОМНАТА </span><span class="caret"></span></a>
...
"></div>
			...
			<form id="chatForm">
				<div style="margin: 5px">
					...
					<div class="pull-left">
						<span>Игроков онлайн: <span id="isonline">0</span></span>
					</div>
					<div class="pull-right">
						<a href="#" class="clearChat">Очистить чат</a>
					</div>
					<br>
					<div class="checkbox pull-right" style="margin: 0px">
						<label class="noselect"><input type="checkbox" id="scroll"><span>Приостановить чат</span></label>
					</div>
					<div class="pull-left">
						<a href="#" data-toggle="modal" data-target="#chatRules">Правила чата</a>
					</div>
				</div>
			</form>
		</div>
		...
		<div class="panel panel-default">
			<div class="panel-body" style="margin-top: 10px;">
				<div><span class="settings-header">ЯЗЫК</span><span class="settings-header">ШАБЛОН</span></div>
				<ul class="nav settings-header" style="padding-top: 10px; display: inline-block;">
					<li class="dropdown">
						<img class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" src="/template/img/lang/ru.png">
						<ul class="dropdown-menu" role="menu" style="min-width: 32px;margin-left: 24%;">
							<li><a href="?language=en"><img src="/template/img/lang/ru.png"></a></li>
						</ul>
					</li>
				</ul>
		...
		<div class="panel panel-default">
			<div class="panel-body text-center" style="margin-top: 10px;">
				<span>АКТИВНЫЕ СТРИМЕРЫ</span>
				<div id="streamoff" style="margin-top: 20px;">Все стримеры оффлайн!</div>
				<div class="streamers">     
				</div>
			</div>
		</div>
		...
		<div class="well text-center" style="padding:5px;margin-bottom:5px"><div id="past"></div>
			...
			<div class="form-group">
				<div class="input-btn bet-buttons">
					...
					<button type="button" class="btn btn-danger betshort" data-action="clear">Очистить</button>
					...
					<button type="button" class="btn btn-primary betshort" data-action="max">Макс</button>
				</div>
			</div>
				...
				<div class="col-xs-4 betBlock" style="padding-right:0px">
					...
					<div class="panel panel-default bet-panel" id="panel1-7-m" style="width: 220px; margin: auto; margin-bottom: 10px;">
						<div class="panel-body" style="padding:0px">
							<div class="my-row">
								<div class="text-center">Ваша ставка:<span class="mytotal">0</span></div>
							</div>
						</div>
					</div>
					<div class="panel panel-default bet-panel" id="panel1-7-t">
						<div class="panel-body" style="padding:0px" id="panel1-7">
							<div class="total-row">
								<div class="text-center">Общая ставка: <span class="total">0</span></div>
							</div>
