...
<div class="list-group">
	...
	<a href="#q1" class="list-group-item">What X2DROP.COM?</a>
    ...
    <div class="col-md-9">
            ...
            <h4 id="q4" class="text-warning">My items are not showing up for deposit?</h4>
                <p>First, make sure your inventory is set to public.</p><p>By default X2DROP.COM loads items from cache. Occasionally this may become out of date. To load directly from Steam (and update the cache) click the “force reload” button.</p>
            ...
            <h4 id="q9" class="text-warning">How does it work?</h4>
                <p>Each roll is computed using the SHA-256 hash of 3 distinct inputs.</p><p>First, is the server seed. This is a precomputed value generated by X2DROP.COM some time in the past. Seeds are generated in a chain such that today's seed is the hash of tomorrow's seed. Since there is no way to reverse SHA-256 we can prove each seed was generated in advance by working backwards from a precomputed chain.</p>
...
echo "Round $round_id = $roll";</pre>
	...
	<div class="">
		...
		<ul class="list-inline" style="display:inline-block;margin-top:10px">
			<li>Copyright &copy; 2016, X2DROP.COM - All rights reserved.</li>
